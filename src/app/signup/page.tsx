...
export default function SignupPage() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    toast({
      ...
      description: "Welcome to Startup Ally! We're redirecting you to your new dashboard.",
    });
      ...
      <div className="w-full max-w-md animate-in fade-in-50 zoom-in-95 duration-500">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Start your journey with Startup Ally today.</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
